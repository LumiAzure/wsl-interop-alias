...
if [ ! -f "$CACHE_FILE" ] || [ "$CONFIG_FILE" -nt "$CACHE_FILE" ]; then
  ...
  echo "# Cached functions created by LumiAzure/wsl-interop-alias" >> "$CACHE_FILE"
  ...
  while IFS= read -r line; do
    ...
    echo "# Shim function generated by LumiAzure/wsl-interop-alias" >> "$FUNC_CACHE_DIR/$func_name"
